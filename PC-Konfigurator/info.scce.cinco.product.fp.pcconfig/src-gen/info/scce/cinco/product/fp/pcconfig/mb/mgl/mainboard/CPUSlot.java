 ...
 *
 *
 * @see info.scce.cinco.product.fp.pcconfig.mb.mgl.mainboard.MainboardPackage#getCPUSlot()
 * @model
 * @generated
 */
public interface CPUSlot extends Container {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	boolean canNewCPUNode();

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedCPURequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	CPUNode newCPUNode(EObject referencedCPU, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedCPURequired="true" idRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	CPUNode newCPUNode(EObject referencedCPU, String id, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedCPURequired="true" xRequired="true" yRequired="true" widthRequired="true" heightRequired="true"
	 * @generated
	 */
	CPUNode newCPUNode(EObject referencedCPU, int x, int y, int width, int height);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedCPURequired="true" idRequired="true" xRequired="true" yRequired="true" widthRequired="true" heightRequired="true"
	 * @generated
	 */
	CPUNode newCPUNode(EObject referencedCPU, String id, int x, int y, int width, int height);
