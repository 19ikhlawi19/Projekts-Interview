package info.scce.cinco.product.fp.pcconfig;
...
public class ConfiguratorProjectWizard extends Wizard implements IWorkbenchWizard {
	...
	public boolean performFinish() {
		...
		try {
			workbench.showPerspective("info.scce.cinco.product.fp.pcconfig.configuratorperspective", workbench.getActiveWorkbenchWindow());
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle("New Configurator Project");
	}
	...
	private class CreateNewProjectPage extends WizardPage {
		...
		protected CreateNewProjectPage(String pageName) {
			super(pageName);
			setTitle("New Configurator Project");
			setDescription("Initialize an empty Configurator project and switch to correct perspective");
