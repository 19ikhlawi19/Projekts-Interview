...
public class PCIncomingCheck extends PCCheck {
  @Override
  ...
  public void check(final PC model) {
    ...
    Iterables.<Node>filter(ListExtensions.<PCId, IdentifiableElement>map(this.adapter.getEntityIds(), _function), Node.class).forEach(_function_1);
  }
