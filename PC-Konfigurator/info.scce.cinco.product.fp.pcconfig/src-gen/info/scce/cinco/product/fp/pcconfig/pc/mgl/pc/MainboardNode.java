 ...
 *
 *
 * @see info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PcPackage#getMainboardNode()
 * @model
 * @generated
 */
public interface MainboardNode extends Container {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	boolean isExactlyMainboardNode();
	 ...
	 * @generated
	 */
	PCGPUNode newPCGPUNode(int x, int y);
	 ...
	 * @generated
	 */
	PCGPUNode newPCGPUNode(String id, int x, int y);
	 ...
	 * @generated
	 */
	PCGPUNode newPCGPUNode(int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCGPUNode newPCGPUNode(String id, int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCCPUNode newPCCPUNode(int x, int y);
	 ...
	 * @generated
	 */
	PCCPUNode newPCCPUNode(String id, int x, int y);
	 ...
	 * @generated
	 */
	PCCPUNode newPCCPUNode(int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCCPUNode newPCCPUNode(String id, int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCRAMNode newPCRAMNode(int x, int y);
	 ...
	 * @generated
	 */
	PCRAMNode newPCRAMNode(String id, int x, int y);
	 ...
	 * @generated
	 */
	PCRAMNode newPCRAMNode(int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCRAMNode newPCRAMNode(String id, int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCRAMSlot newPCRAMSlot(int x, int y);
	 ...
	 * @generated
	 */
	PCRAMSlot newPCRAMSlot(String id, int x, int y);
	 ...
	 * @generated
	 */
	PCRAMSlot newPCRAMSlot(int x, int y, int width, int height);
	 ...
	 * @generated
	 */
	PCRAMSlot newPCRAMSlot(String id, int x, int y, int width, int height);
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" pCMainboardContainerRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	boolean canMoveTo(PCMainboardContainer pCMainboardContainer, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model pCMainboardContainerRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	void moveTo(PCMainboardContainer pCMainboardContainer, int x, int y);
	 ...
	 * @generated
	 */
	void s_moveTo(PCMainboardContainer pCMainboardContainer, int x, int y);
	 ...
	 * @generated
	 */
	PCMainboardContainer getContainer();
	 ...
	 * @generated
	 */
	MainboardNodeView getMainboardNodeView();
