...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PCRAM Node</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PcPackage#getPCRAMNode()
 * @model
 * @generated
 */
public interface PCRAMNode extends Node {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	InternalPCRAMNode getInternalPCRAMNode();
	 ...
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" mainboardNodeRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	boolean canMoveTo(MainboardNode mainboardNode, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model mainboardNodeRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	void moveTo(MainboardNode mainboardNode, int x, int y);
	 ...
	 * @generated
	 */
	void s_moveTo(MainboardNode mainboardNode, int x, int y);
	 ...
	 * @generated
	 */
	PCRAMNodeView getPCRAMNodeView();
