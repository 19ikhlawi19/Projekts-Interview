 ...
 * </p>
 * <ul>
 *   <li>{@link info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.internal.impl.InternalMainboardNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.internal.impl.InternalMainboardNodeImpl#getLibraryComponentUID <em>Library Component UID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InternalMainboardNodeImpl extends InternalContainerImpl implements InternalMainboardNode {
	/**
	 ...
	 * @generated
	 */
	protected InternalMainboardNodeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return InternalPackage.Literals.INTERNAL_MAINBOARD_NODE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_MAINBOARD_NODE__NAME, oldName, name));
	}
	...
	public void setLibraryComponentUID(String newLibraryComponentUID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InternalPackage.INTERNAL_MAINBOARD_NODE__LIBRARY_COMPONENT_UID, oldLibraryComponentUID, libraryComponentUID));
	}
	...
	public EList<ContainmentConstraint> getContainmentConstraints() {
		...
		constraints.add(new ContainmentConstraint(0,-1,info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PCCPUNode.class));
		constraints.add(new ContainmentConstraint(0,-1,info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PCGPUNode.class));
		constraints.add(new ContainmentConstraint(0,-1,info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PCRAMNode.class));
		constraints.add(new ContainmentConstraint(0,-1,info.scce.cinco.product.fp.pcconfig.pc.mgl.pc.PCRAMSlot.class));
		return constraints;
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InternalPackage.INTERNAL_MAINBOARD_NODE__NAME:
				return getName();
			case InternalPackage.INTERNAL_MAINBOARD_NODE__LIBRARY_COMPONENT_UID:
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == InternalModelElementContainer.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_MODEL_ELEMENT_CONTAINER___GET_CONTAINMENT_CONSTRAINTS: return InternalPackage.INTERNAL_MAINBOARD_NODE___GET_CONTAINMENT_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == InternalContainer.class) {
			switch (baseOperationID) {
				case graphmodel.internal.InternalPackage.INTERNAL_CONTAINER___GET_CONTAINMENT_CONSTRAINTS: return InternalPackage.INTERNAL_MAINBOARD_NODE___GET_CONTAINMENT_CONSTRAINTS;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case InternalPackage.INTERNAL_MAINBOARD_NODE___GET_CONTAINMENT_CONSTRAINTS:
				return getContainmentConstraints();
			case InternalPackage.INTERNAL_MAINBOARD_NODE___GET_REFERENCED_MB:
