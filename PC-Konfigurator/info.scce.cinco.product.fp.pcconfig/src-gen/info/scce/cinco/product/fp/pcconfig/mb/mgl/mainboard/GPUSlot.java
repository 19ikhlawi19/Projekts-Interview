...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>GPU Slot</b></em>'.
 * <!-- end-user-doc -->
 *
 *
 * @see info.scce.cinco.product.fp.pcconfig.mb.mgl.mainboard.MainboardPackage#getGPUSlot()
 * @model
 * @generated
 */
public interface GPUSlot extends Container {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	InternalGPUSlot getInternalGPUSlot();
	 ...
	 * @generated
	 */
	boolean canNewGPUNode();

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedGPURequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	GPUNode newGPUNode(EObject referencedGPU, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedGPURequired="true" idRequired="true" xRequired="true" yRequired="true"
	 * @generated
	 */
	GPUNode newGPUNode(EObject referencedGPU, String id, int x, int y);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedGPURequired="true" xRequired="true" yRequired="true" widthRequired="true" heightRequired="true"
	 * @generated
	 */
	GPUNode newGPUNode(EObject referencedGPU, int x, int y, int width, int height);

	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @model required="true" referencedGPURequired="true" idRequired="true" xRequired="true" yRequired="true" widthRequired="true" heightRequired="true"
	 * @generated
	 */
	GPUNode newGPUNode(EObject referencedGPU, String id, int x, int y, int width, int height);
