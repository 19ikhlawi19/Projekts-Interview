...
public class Hauptfenster extends JFrame{
    ...
    public void ladeMitarbeiter()
    {
        ...
        testMitarbeiter.setName("Marius Beelen");
        ...
        testMitarbeiter.setName("Maniele Kevin");
    ...
    public void ladeMenu()
    {
        ...
        exportierenAlsExcelMenuItem.addActionListener(e -> {
            try {
                ...
                zeilenExcel.add(new String[]{"Id", "Bild", "Name", "Beruf", "Einstellungsdatum", "Jahresgehalt", "Auträge"});
